                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <form method="POST" action="includes/validaraltauser.php">
                            ...
                            <div class="controls">
                                <select name="marca" class="span8 tip" onChange="Tipo_producto(this.value);"  required>
                            ...
                            <label class="control-label" for="basicinput">Tipo de Producto</label>
                            <div class="controls">
                                <select   name="tipo_producto" id="tipo_producto" class="span8 tip" required></select>
                            </div>
                        </form>
                    </div>
                </div>
