...
<head>
    ...
    <script>
        ...
        function mostrarAlerta() {
            alert("Seguro que desea registrar el usuario?");
        }
    </script>
  </head>
                    ...
                    <div class="col-md-9">
                        ...
                        <form method="POST" action="includes/validaraltauser.php">
                            ...
                            <div class="col-6">
                                ...
                                <button class="btn btn-dark btn-lg btn-registrar" onClick="mostrarAlerta()" type="submit" name="registrar">Registrar</button>
                                </div>
                            </div>
                            </div>
                        </form>
