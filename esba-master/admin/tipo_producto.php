...
<head>
    ...
    <script>
        ...
        function mostrarAlerta() {
            alert("Seguro que desea registrar el tipo de producto?");
        }
        // Función para mostrar alerta
        function mostrarAlerta2() {
            alert("Seguro que desea eliminar el tipo de producto?");
        }
    </script>
</head>
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
						    ...
						    <tbody>
                            <?php $query=mysqli_query($conexion,"SELECT tipo_producto.id, tipo_producto.nombre,
                            marca.nombre AS marca
                            FROM tipo_producto
                            JOIN marca ON tipo_producto.id_marca = marca.id
                            WHERE 1=1");
                            while($row=mysqli_fetch_array($query))
                            {
                            ?>
							<tr>
                                ...
                                <td><a href="includes/validarbajatipo_producto.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onClick="mostrarAlerta2()"><i class="fas fa-x fa-1x"></i></a></td>
