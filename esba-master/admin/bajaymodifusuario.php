...
<head>
    ...
    <script>
        ...
        function mostrarAlerta() {
            alert("Seguro que desea eliminar el usuario?");
        }
    </script>
  </head>
                    ...
                    <div class="col-md-9">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
							...
							<tr>
                                ...
                                <td><a href="includes/validarbajausuario.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onClick="mostrarAlerta()"><i class="fas fa-x fa-1x"></i></a></td>
