<?php
    ...
    if(isset($_SESSION['usuario'])) {
        if(isset($_POST['registrar'])){
            ...
            $query = mysqli_query($conexion,"INSERT INTO producto(id_marca,id_tipo_producto,descripcion,precio,stock_central,stock_cordoba,stock_rosario) VALUES('$marca','$tipo_producto','$descripcion','$precio','$stock_central','$stock_cordoba','$stock_rosario')");
        }
