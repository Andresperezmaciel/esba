                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
						    ...
						    <tbody>
                            <?php $query=mysqli_query($conexion,"SELECT * FROM producto");
							...
							<tr>
								...
								<td> <?php echo htmlentities($row['id_tipo_producto']);?> </td>
                                ...
                                <td><a href="includes/validarbajaproducto.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fas fa-x fa-1x"></i></a></td>
