      ...
      function updateCart() {
          ...
          for (const id in carrito) {
              ...
              cartTable.innerHTML += `<tr>
                  ...
                  <td><button onclick='removeFromCart(${id})'>Eliminar</button></td>
              </tr>`;
          }
                    ...
                    <!-- SE COLOCAN LOS DATOS SACADOS DE LA BDD -->
                      ...
                      <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <?php }else{
                            echo"<button class='btn btn-outline-success' onclick='addToCart({$row['id']}, \"{$row['descripcion']}\", {$row['precio']}, document.getElementById(\"ubicacion-{$row['id']}\").value)'>Añadir al carrito</button>";
                            } ?>
                        </div>
                      </div>
                    </div>
      ...
      <table border="1">
            ...
            <tfoot>
                <tr>
                    ...
                    <td><button onclick="checkout()">Pagar</button></td>
                </tr>
            </tfoot>
        </table><br><br>  
      </div>
