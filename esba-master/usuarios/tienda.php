...
<html lang="en">
  <head>
    ...
    <script>
      ...
      function addToCart(id, descripcion, precio, ubicacion) {
          if (!carrito[id]) {
              carrito[id] = {
                  id: id,
                  precio: precio,
      ...
      function updateCart() {
          ...
          for (const id in carrito) {
              ...
              cartTable.innerHTML += `<tr>
                  ...
                  <td><input type='number' value='${producto.cantidad}' min='1' onchange='updateQuantity(${id}, this.value)'></td>
                  <td>${producto.precio * producto.cantidad}</td>
                  <td><button class='btn btn-danger' onclick='removeFromCart(${id})'><i class="fas fa-trash fa-1x"></button></td>
              </tr>`;
          }
                      ...
                      <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <?php }else{?>
                            ...
                            echo"<button class='btn btn-outline-success' onclick='addToCart({$row['id']}, \"{$row['descripcion']}\", {$row['precio']}, document.getElementById(\"ubicacion-{$row['id']}\").value)'><i class='fas fa-shopping-cart fa-1x'></i> Añadir al carrito</button>";
                            } ?>
                        </div>
                      </div>
                    </div>
      ...
      <table border="1">
            ...
            <tfoot>
                <tr>
                    ...
                    <td><button class="btn btn-success" onclick="checkout()">Comprar</button></td>
                </tr>
            </tfoot>
        </table><br><br>  
      </div>
