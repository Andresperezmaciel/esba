	...
	<div class="container">
		<div class="header-top-inner">
			<div class="cnt-account">
				...
				<li><a href="#" class="userheader"><i class="icon fa fa-user"></i> Bienvenid@ - <?php echo htmlentities($_SESSION['usuario']);?></a></li>
					<li><a href="my-cart.php" class="userheader"><i class="icon fa fa-shopping-cart"></i> Mi Carrito</a></li>
                    <li><a href="logout.php" class="userheader"><i class="icon fa fa-sign-out"></i> Logout</a></li>
				</ul>
			</div>
        </div>
    </div>
