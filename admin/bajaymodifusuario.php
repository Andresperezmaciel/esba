...
?>									
								<tr>
                                    ...
                                    <td><form action="includes/validarbajausuario.php"><button type="submit" name="baja"><i class="fas fa-x fa-1x"></i></button></form></td>
                                    <td><button name="modif"><i class="fas fa-pencil fa-1x"></i></button></td>
