            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <form method="POST" action="includes/validaraltaproducto.php" enctype="multipart/form-data">
                            <div class="row gy-3 overflow-hidden justify-content-center text-center">
                                ...
                                <div class="col-7">
                                    ...
                                    <div class="controls">
                                        <input type="file" name="imagen" id="imagen" value="registrar" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="justify-content-center text-center">
                                        <button class="btn btn-dark btn-lg btn-registrar" type="submit" name="registrar" value="registrar">Registrar</button>
                                    </div>
                                </div>
                            </div>
                        </form>
